...
gulp.task("default", gulp.series(["watch", "browserify", "sass", "unit tests", "index", "resize sm", "resize md", "resize lg", "generate sprites", "minify-js", "minify-css"], function (done) {
  done();
}));
